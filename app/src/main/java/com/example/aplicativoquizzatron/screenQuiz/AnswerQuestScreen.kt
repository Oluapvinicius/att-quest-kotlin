...
import com.example.aplicativoquizzatron.components.LogoPequena
import com.example.aplicativoquizzatron.quest.ModelQuest

var pontos = 0
var step = 1

fun OpcionCorrect(opcoes: List<String>, certo: List<String>) {
...
@Composable
fun AnswerQuestion(modifier: Modifier = Modifier,navController: NavController) {
...
//              -> alt.correta
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(color = colorResource(R.color.wpinka))
            .padding(16.dp),
